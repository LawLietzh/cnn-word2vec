...
class TextCNN(object):
    ...
    """
    def __init__(
      self, file_path, sequence_length, num_classes, dropout_keep_prob,
      embedding_size, filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        print 'self.input_x.shape:',self.input_x.shape
        ...
        #    W = tf.Variable(tf.random_uniform([16,embedding_size], -1.0, 1.0),name="W")
